                ...
                <tbody>
                  {recentConstellations.map((item, i) => (
                    <tr
                      key={item.id}
                      className={
                        i !== recentConstellations.length - 1
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <span
                          className={`px-2 py-1 rounded-full text-xs font-medium ${item.status === "Public" ? "bg-emerald-50 text-emerald-600" : "bg-slate-100 text-slate-600"}`}
                        >
                          {item.status}
                        </span>
                      </td>
